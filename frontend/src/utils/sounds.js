...
// enunciados (feedback)
import enunciadoMuyBien from "../assets/sounds/enunciados/muy-bien.mp3";
import enunciadoSigueAsi from "../assets/sounds/enunciados/sigue-asi.mp3";
import enunciadoLoEstasHaciendoExcelente from "../assets/sounds/enunciados/lo-estas-haciendo-excelente.mp3";
import enunciadoTuPuedes from "../assets/sounds/enunciados/tu-puedes.mp3";
import enunciadoIntentaloDeNuevo from "../assets/sounds/enunciados/intentalo-de-nuevo.mp3";
import enunciadoVasMuyBien from "../assets/sounds/enunciados/vas-muy-bien.mp3";
import enunciadoUnPasoALaVez from "../assets/sounds/enunciados/un -paso-a-la-vez.mp3";
import enunciadoCadaVezLoHacesMejor from "../assets/sounds/enunciados/cada-vez-lo-haces-mejor.mp3";
import enunciadoEsaNoEs from "../assets/sounds/enunciados/esa-no-es.mp3";
import enunciadoEsfuerzateUnPocoMas from "../assets/sounds/enunciados/esfuerzate-un-poco-mas.mp3";
import enunciadoTranquiloPuedesVolverAIntentarlo from "../assets/sounds/enunciados/tranquilo-puedes-volver-a-intentarlo.mp3";
import enunciadoConfioEnTi from "../assets/sounds/enunciados/confio-en-ti.mp3";
import enunciadoMuyBienLoLograste from "../assets/sounds/enunciados/muy-bien-lo-lograste.mp3";
import enunciadoExcelente from "../assets/sounds/enunciados/excelente.mp3";
import enunciadoEresUnCampeon from "../assets/sounds/enunciados/eres-un-campeon.mp3";
import enunciadoAdelanteTuPuedes from "../assets/sounds/enunciados/adelante.mp3";
//a
...
import angelSound from "../assets/sounds/angel.mp3";
import ardillaSound from "../assets/sounds/ardilla.mp3";
//e
...
import esferoSound from "../assets/sounds/e/esfero.mp3";
...
import ubicacionSound from "../assets/sounds/u/ubicacion.mp3";
